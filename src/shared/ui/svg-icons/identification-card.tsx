const SVGIconsIdentificationCard = () => {
    return (
        <svg width="16rem" height="16rem" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.5 7H12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.5 9H12" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
            <path
...
export default SVGIconsIdentificationCard;
